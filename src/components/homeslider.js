...
<div className="carousel slide" data-bs-ride="carousel" id="carouselExampleIndicators">
        ...
        <div className="carousel-inner">
          <div  className="carousel-item active">
            <img  className="d-block w-100" src={"./images/home_slider_1.jpg"} />
            <div className="carousel-caption">
              <h1 className="animated bounceInRight" style={{animationDelay: "1s" ,color:"black", fontSize: "70px"}}>Edumoon</h1>

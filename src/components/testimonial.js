...
<div className="sai">
    <div className="container" style={{background: "linear-gradient(to bottom, #000428, #004683)", animation: "background-color 120s",minHeight: "62vh", marginTop: "80px" ,border: "5px solid white" ,borderRadius: "27px" ,  overflow: "hidden"}}>
        <div className="row">
            ...
            <div className="col-lg-4">
                <div style={{backgroundColor: "rgba(0,0,0,0)"}} className="card">
                    ...
                    <div className="face back-face"> <span className="fas fa-quote-left"></span>
                        <div className="testimonial"> I've taken the 2 day workshop of Web Development from Edumoon! It was very helpful. I've learnt basics about Javascript and MySQL. I've completely understood HTML, CSS. The assignments which were given on day 1,2 helped us to understand how much we've learned in the session. Instructors were very helpful, they've clarified the doubts and responded immediately. Thank you for this wonderful session! </div> <span className="fas fa-quote-right"></span>
                    </div>
                </div>
            </div>
